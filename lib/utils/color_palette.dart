...
class ColorPalette {
  ...
  // Light mode colors
  static const Color lightAccentColor = Color(0xFF0083C9);
  static const Color lightPrimaryColor = Color(0xFF005AA1);
  static const Color lightSecondaryColor = Color(0xFF065EA3);
